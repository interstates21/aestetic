NAME = doom_nukem
CC = clang
FILES = color_math console_output linear_math main sdl_helpers sdl_init vector_math controls_listen controls_apply load_data player_init sector_init vertex_init  controls_init render_manager temp_render brazenhem
LIBFT_DIR = libft/
