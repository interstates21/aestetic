NAME = doom_nukem
CC = clang
FILES = color_math console_output linear_math small_funcs_2 small_funcs main sdl_helpers sdl_init vector_math controls_listen controls_mouse_apply render_init controls_apply load_data player_init sector_init vertex_init draw_line controls_init render_manager temp_render temp_draw_screen
LIBFT_DIR = libft/
