...
t_sect		init_sector(t_wall **walls, int n_walls)
{
	...
	res = (t_sect){.height[H_CEIL] = 40, .height[H_FLOOR] = 10,
...
void 		init_default_sect(t_ed *e)
{
	...
	walls[0] = (t_wall){.is_door = 0, .is_portal = 0,
	.v1 = (t_v2){ trim(ED_W >> 1, 1), trim(ED_H >> 1, 1) },
	.v2 = (t_v2){ trim(ED_W >> 1, 1), trim(ED_H >> 1, -1) }};
	walls[1] = (t_wall){.is_door = 0, .is_portal = 0,
	.v1 = (t_v2){ trim(ED_W >> 1, 1), trim(ED_H >> 1, -1) },
	.v2 = (t_v2){ trim(ED_W >> 1, -1), trim(ED_H >> 1, -1) }};
	walls[2] = (t_wall){.is_door = 0, .is_portal = 0,
	.v1 = (t_v2){ trim(ED_W >> 1, -1), trim(ED_H >> 1, -1) },
	.v2 = (t_v2){ trim(ED_W >> 1, -1), trim(ED_H >> 1, 1) }};
	walls[3] = (t_wall){.is_door = 0, .is_portal = 0,
	.v1 = (t_v2){ trim(ED_W >> 1, -1), trim(ED_H >> 1, 1) },
	.v2 = (t_v2){ trim(ED_W >> 1, 1), trim(ED_H >> 1, 1) }};
	e->seclist[0] = init_sector(&walls, 4);
}
